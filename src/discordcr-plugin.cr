...
module Discord
  ...
  module Plugin
    ...
    EVENTS = {
      ...
      :guild_members_chunk, :guild_role_create, :guild_role_update, :guild_role_delete, :message_create,
      :message_reaction_add, :message_reaction_remove, :message_reaction_remove_all, :message_update,
